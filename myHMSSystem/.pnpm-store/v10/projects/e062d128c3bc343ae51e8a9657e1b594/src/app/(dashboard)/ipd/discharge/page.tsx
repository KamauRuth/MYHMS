  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Patient Discharge</h1>
        <p className="text-gray-600 mb-6">Create discharge summaries and discharge patients</p>

        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Ready to Discharge</h2>
          {admissions.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {admissions.map((admission) => (
                <Link
                  key={admission.id}
                  href={`/ipd/admission/${admission.id}/discharge/new`}
                ...
                >
                  ...
                  <p className="text-sm text-gray-600 mt-2">→ Create Discharge Summary</p>
                </Link>
              ))}
            </div>
          )}
