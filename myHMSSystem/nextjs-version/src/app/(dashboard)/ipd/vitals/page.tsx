  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Vital Signs Recording</h1>
        <p className="text-gray-600 mb-6">Record and track patient vital signs</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {admissions.map((admission) => (
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-600 mt-2">→ Record Vitals</p>
                  </Link>
                ))}
              </div>
            )}
